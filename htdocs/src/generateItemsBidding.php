<?php
    function generateItemsBidding($row, $row2, $showButtons, $showWatch) {
            $uploadPath = "../../.." . "/src/Validate/";
            $htmlOut = "<tr>";
            $htmlOut .= "<td>";
            $htmlOut .=  "<img src=". $uploadPath . $row['photo'] . " width=350px" . ">";
            $htmlOut .= "</td>";
            $htmlOut .= "<td>";
            ...
            $htmlOut .= "</tr>";
                ...
                $htmlOut .= "<tr>";
                $htmlOut .= "<td>" . 'Your Bid: £' . $row['bidValue'] . "</td>";
                $htmlOut .= "</tr>";

                $htmlOut .= "<tr>";
                $htmlOut .= "<td>" . 'Highest Bid: £' . $row2['MaxBid'] . "</td>";
                $htmlOut .= "</tr>";
